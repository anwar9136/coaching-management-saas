...
export function InstructorCleanSidebar() {
  ...
  const navItems = [
    ...
    { label: "My Lectures", path: "/instructor/my-lectures", icon: Calendar },
    { label: "My Profile", path: "/instructor/profile/edit", icon: User },   // ← New
  ];
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white border-r border-neutral-200/60 flex flex-col z-40">
      ...
      <div className="p-5 border-t border-neutral-200/60">
        <div className="flex items-center gap-3.5 px-5 py-4 mb-4 bg-transparent">
